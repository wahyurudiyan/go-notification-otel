...
func (c *notificationServiceClient) SendPushNotification(ctx context.Context, in *PushNotificationRequest, opts ...grpc.CallOption) (*PushNotificationResponse, error) {
...
func (UnimplementedNotificationServiceServer) SendPushNotification(context.Context, *PushNotificationRequest) (*PushNotificationResponse, error) {
